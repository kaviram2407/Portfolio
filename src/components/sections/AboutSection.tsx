...
export function AboutSection() {
  ...
  return (
    <SectionContainer id="about">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center mb-24 w-full min-w-0">
        
        {/* Left Side: Plaid shirt portrait cutout with laptop & coffee */}
        <div className="col-span-1 lg:col-span-5 flex justify-center w-full min-w-0">
          <AnimWrapper variant="scale-up" className="w-full max-w-sm min-w-0">
            <GlassCard interactive={true} className="p-4 border-white/5 bg-[#05050a]/40 relative overflow-hidden group w-full min-w-0">
              ...
              <div className="rounded-xl overflow-hidden bg-[#07060c]/80 flex justify-center items-center relative z-10 border border-white/5 w-full min-w-0">
                <img
        ...
        <div className="col-span-1 lg:col-span-7 flex flex-col w-full min-w-0">
          ...
          <div className="relative pl-6 border-l border-primary/20 flex flex-col gap-6 w-full min-w-0">
            {progression.map((step, index) => {
              ...
              return (
                <div
                  ...
                  className="relative group cursor-default w-full min-w-0"
                >
                  ...
                  <AnimWrapper variant="fade-up" delay={index * 0.08} className="w-full min-w-0">
                    <div className={cn(
                      "p-4 rounded-xl border bg-white/[0.01] transition-all duration-300 w-full min-w-0",
                      isHovered
                        ? "border-primary/40 bg-primary/[0.02] shadow-[0_0_12px_rgba(139,92,246,0.1)] translate-x-1"
                        : "border-white/5"
                    )}>
                      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-1.5 mb-2 w-full min-w-0">
                        <h4 className="text-xs font-bold text-white uppercase tracking-wide truncate">
                          {step.title}
                        </h4>
                        <span className="text-[8px] font-bold font-mono text-primary uppercase whitespace-normal sm:whitespace-nowrap shrink-0">
